...
[`@aws-sdk/client-backupsearch`](https://www.npmjs.com/package/@aws-sdk/client-backupsearch/v/3.1060.0).
...
- @aws-sdk/client-backupsearch v3.1060.0 - [https://cloud-sdk-builds.github.io/?sdk=client-backupsearch&version=3.1060.0](https://cloud-sdk-builds.github.io/?sdk=client-backupsearch&version=3.1060.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-backupsearch@3.1060.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aSSzvzNf98d+L7+tPv+XAC6izcd+zcarJQbr/LCFIJcfSxYFacxwWuqLu8SjTNaW
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-backupsearch": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-backupsearch@3.1060.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-backupsearch@3.1060.0/index.min.mjs": "sha384-aSSzvzNf98d+L7+tPv+XAC6izcd+zcarJQbr/LCFIJcfSxYFacxwWuqLu8SjTNaW"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-backupsearch/blob/refs/tags/3.1060.0/LICENSE
```
